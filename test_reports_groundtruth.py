...
check("...printing the origin the public API's own examples call, as the guess",
      groundtruth_map.DEFAULT_BASE == "https://api-public.groundtruth.com" and "api-public.groundtruth.com" in page)
