...
PRODUCERS = [
    ...
    {"key": "image_picker", "label": "Client Image Uploads",
     "provider": ["local", "camera", "url", "google_drive", "google_photos",
                  "dropbox", "facebook", "instagram", "image_search"],
     "module": "modules/image_picker/filing.py", "makes": "upload",
     "why": "What a client sends us through their own upload link."},
    {"key": "media_collector_website", "label": "Media Collector Website Import",
     "provider": ["website"],
     "module": "modules/image_picker/collectors.py", "makes": "upload",
     "why": "Images collected from a client's existing public website."},
