...
SCENARIOS: list[Scenario] = [
    ...
    Scenario(key="google_access.cleanup_review", module="google_access",
        ...
        minutes=6, path="/tools/google-access/qa-inactive/", steps=[
            ...
            Step("Check the resource and account", "Review the inactivity evidence for each GA4 property or GTM container.", "Without confirmed GA4 activity a container starts as a candidate. Automatic site checks move tags found on a page to Needs Review; installation is not measured traffic."),
