...
| File | Topic | Lines |
|---|---|---|
| [`03-traps-every-one-of-these-has-cost-a-working-feature.md`](03-traps-every-one-of-these-has-cost-a-working-feature.md) | Traps — every one of these has cost a working feature | 1373 |
...
| [`43-the-one-module-that-is-not-python.md`](43-the-one-module-that-is-not-python.md) | The one module that is not Python | 829 |
...
| [`49-what-the-ad-report-syncs-propose-and-the-person-who-stands-b.md`](49-what-the-ad-report-syncs-propose-and-the-person-who-stands-b.md) | What the ad-report syncs propose, and the person who stands behind each | 273 |
...
| [`56-verifying-a-change.md`](56-verifying-a-change.md) | Verifying a change | 1051 |
...
| [`72-one-page-per-provider-and-the-fields-left-on-the-table.md`](72-one-page-per-provider-and-the-fields-left-on-the-table.md) | One page per provider, and the fields left on the table | 88 |
