...
| [`71-one-page-per-provider-and-the-fields-left-on-the-table.md`](71-one-page-per-provider-and-the-fields-left-on-the-table.md) | One page per provider, and the fields left on the table | 88 |
