...
> Exported from the Claude Doc "Lake Cam 2.0 — Design & Build Spec" on 2026-09-17. The build that follows it is `modules/camhub/`; `docs/claude/80-camhub-a-conditions-page-with-a-sponsor-system-behind-it.md` records what was built and where it departs from this text.
