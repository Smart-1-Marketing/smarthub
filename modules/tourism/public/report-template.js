...
if (typeof window !== 'undefined') {
  window.Smart1ReportTemplate = { buildReportMarkup, getSeasons, getDayparts, getHolidayRecs, getAudiences, getProductPlan, reportDateString, weatherTriggerLabel, classifyWebPresence };
}
