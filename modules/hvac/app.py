...
def generate_report(payload: dict) -> Any:
    ...
    try:
        ...
        _hub_ai.note_usage("hvac", _data, purpose="market_report")
...
try:
    ...
    _s1_embed.install(app, 'Smart 1 Marketing — HVAC Marketing Gameplan', default_height=1500, view=index)
